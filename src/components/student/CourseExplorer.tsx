...
export const CourseExplorer: React.FC = () => {
  ...
  // If viewing a course, render CourseViewer
  if (viewingCourse) {
    return (
      <CourseViewer
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span>{selectedCourse.studentsEnrolled || 0} estudiantes</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="w-4 h-4" />
                  <span>{selectedCourse.rating ? selectedCourse.rating.toFixed(1) : '0.0'} ({selectedCourse.studentsEnrolled || 0} reseñas)</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4" />
                  <span>{selectedCourse.duration || 0} horas</span>
                </div>
              ...
              {isEnrolled(selectedCourse.id) ? (
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-white text-blue-600 px-4 py-2 rounded-lg font-medium hover:bg-blue-50 flex items-center justify-center gap-2"
                  >
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-500">
                    ...
                    {isEnrolled(course.id) && (
                      <button
                        ...
                        className="ml-2 px-3 py-1 bg-blue-600 text-white text-xs rounded-full hover:bg-blue-700 transition-colors flex items-center gap-1"
                      >
                        <Play className="w-3 h-3" />
                        Acceder
                      </button>
